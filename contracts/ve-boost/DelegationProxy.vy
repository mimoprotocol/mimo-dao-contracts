...
def adjusted_balance_of(_account: address) -> uint256:
    """
    @notice Get the adjusted veMIMO balance from the active boost delegation contract
    @param _account The account to query the adjusted veMIMO balance of
    @return veMIMO balance
    """
